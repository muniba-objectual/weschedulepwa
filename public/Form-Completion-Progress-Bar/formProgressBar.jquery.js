$.fn.formProgressBar = function(options) {
    ...
    $("#jQueryProgressFormBar").css("position","relative").css("top",0).css("left",0).css("width","100%").css("height",settings.height).css("z-index",10000)
    ...
    this.elementsRequied = function () {
        var formElements = $(this).find("input[countme], textarea[countme], select[countme]").toArray()
        arr = [];
    ...
    this.bindElements = function () {
        ...
        $(this).find("input[countme], textarea[countme], select[countme]").change(function () {
        ...
        if(settings.readCount) {
            var $div = $(this).find("input[countme], textarea[countme], select[countme]");
