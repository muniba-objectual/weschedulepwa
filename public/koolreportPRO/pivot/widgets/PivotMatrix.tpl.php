...
//     echo "rowNodeInfo = "; Util::prettyPrint($rowNodeInfo); echo "<br>";
// }

$numDF = count($dataFields) > 0 ? count($dataFields) : 1;
// echo "I am a PivotMatrix<br>";
// return;
if ($this->showUsage) {
...
<div id="<?= $uniqueId ?>" class='krPivotMatrix animated' style="width:<?= $width ?>; height:<?= $height ?>; 
        overflow: hidden; 
    ...
    <table class='table'>
        ...
        <tbody>
            <tr>
                <td class='krpmFieldZone krpmWaitingFieldZone' data-zone="waiting" colspan=2>
                    <?php
                    $zone = "waiting";
            ...
            <tr>
                <td class='krpmFieldZone krpmDataFieldZone' data-zone="data">
                    <?php
                    $zone = "data";
                ...
                <td class='krpmFieldZone krpmColumnFieldZone' data-zone="column" colspan=1>
                    <?php
                    $zone = "column";
            ...
            <tr>
                <td class='krpmFieldZone krpmRowFieldZone' data-zone="row">
                    <?php
                    $zone = "row";
                ...
                <td class='krpmColumnHeaderZone' style="height: 100%;">
                    <?php
            ...
            <tr class='krpmTrFooter'>
                <td class='krpmFooter' colspan=<?= count($rowFields) + count($colIndexes) * $numDF; ?>>
    ...
    <div id="krpmDisabler" style="display: none">
        <i class="krpmSpin krpmLoading fas fa-refresh fa-spin fa-3x fa-fw"></i>
    </div>
    <div id="krpmColumnFieldMenu" class="krpmFieldMenu" tabindex="0" style="display: none;">
    ...
    <div id="krpmRowFieldMenu" class="krpmFieldMenu" tabindex="0" style="display: none;">
        <div class='krpmMenuItem' data-command='expand'>Expand All
            <i class='far fa-plus-square' aria-hidden='true'></i>
        </div>
        <div class='krpmMenuItem' data-command='collapse'>Collapse All
    ...
    <div id="krpmDataFieldMenu" class="krpmFieldMenu" tabindex="0" style="display: none;">
    ...
    KoolReport.widget.init(
        ...
        function() {
            var <?= $uniqueId ?>_data = {
                ...
                isAjaxUpdate: <?php echo $isUpdate ? 1 : 0; ?>,
...
if ($this->showUsage) {
    ...
    echo "rendering time = " . $time_elapsed_secs . "<br>";
    echo "PHP memory usage =  " . number_format(memory_get_usage()) . "<br>\n";
}
?>