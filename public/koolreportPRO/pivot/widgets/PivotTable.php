...
class PivotTable extends Widget
{
    ...
    protected function onInit()
    {
        ...
        $this->rowTotalAtBeginning = Util::get($this->params, 'rowTotalAtBeginning', false);
        $this->columnTotalAtBeginning = Util::get($this->params, 'columnTotalAtBeginning', false);
    }
    ...
    protected function onRender()
    {
        ...
        $this->pivotUtil = new PivotUtil($this->dataStore, $this->params);
        $this->pivotUtil->setTemplate($this->template);
        $this->pivotUtil->process();
        $FieldsNodesIndexes = &$this->pivotUtil->FieldsNodesIndexes;

        // echo "mappedColNodes = "; Util::prettyPrint($FieldsNodesIndexes['mappedColNodes']);
