...
?>
<li class="nav-item<?php echo $_itemProps["hidden"]===true?" d-none":"";?>">
    <a data-path="<?php echo htmlspecialchars(json_encode($path)); ?>" data-name="<?php echo $menuItem->name(); ?>" onclick="<?php echo $_itemProps["onClick"]; ?>" target="<?php echo $_itemProps["target"]; ?>" style="<?php echo $_itemProps["cssStyle"]; ?>" class="nav-link<?php echo " ".$_itemProps["cssClass"]; ?>" href="<?php echo $_itemProps["href"]; ?>">
