...
?>
<div title="<?php echo $_props["title"]; ?>" <?php echo ($_props["onClick"]!=null)?"onclick=\"".Client::exec($_props["onClick"])."\"":""; ?> class="card <?php echo $_props["cssClass"]; ?>" style="<?php echo $_props["cssStyle"]; ?>">
