...
if ($this->baseValue) {
    ...
    $indicatorTitle = str_replace("{indicatorValue}", (string)$this->formatValue($indicatorValue, $this->indicatorFormat), (string)$indicatorTitle);

    $infoText = str_replace("{baseValue}", (string)$this->formatValue($this->baseValue, $this->valueFormat), (string)$this->infoText);
    $infoText = str_replace("{value}", (string)$this->formatValue($this->value, $this->valueFormat), (string)$infoText);
    $infoText = str_replace("{indicatorValue}", (string)$this->formatValue($indicatorValue, $this->indicatorFormat), (string)$infoText);
}
