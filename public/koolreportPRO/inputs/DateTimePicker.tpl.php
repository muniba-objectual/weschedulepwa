...
?>
    <div id='<?php echo $this->name; ?>' class='input-group date'>
        <input type='text' class="form-control" <?php echo $this->disabled?"disabled='disabled'":""; ?> />
...
{
?>
    <input id='<?php echo $this->name; ?>' type='text' class="form-control" <?php echo $this->disabled?"disabled='disabled'":""; ?> />
<?php    
}
?>
...
KoolReport.widget.init(<?php echo json_encode($this->getResources()); ?>,function(){
    ...
    name.disable = function(bool) {
        $('#<?php echo $this->name; ?> input.form-control').attr('disabled',bool);
    };
