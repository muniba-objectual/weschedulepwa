...
?>
    <div class="<?php echo $this->display=="horizontal"?"checkbox-inline":"checkbox"; ?>">
        <label>
            <input type="checkbox" aName="<?php echo $this->name; ?>" name="<?php echo $this->name."[]"; ?>" value="<?php echo $value ?>" <?php echo(in_array($value,$this->value))?"checked":""; ?><?php echo $this->disabled?" disabled":"";?>>
            <?php echo $text; ?>
        </label>
    </div>
<?php
