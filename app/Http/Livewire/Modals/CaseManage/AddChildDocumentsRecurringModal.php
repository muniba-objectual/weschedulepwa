...
class AddChildDocumentsRecurringModal extends Modal
{
    use WithMedia;
   ...
   public $type;
    ...
    public function submit()
    {
        // Do Something With Your Modal
            ...
            $formSubmission = ChildDocuments::create([
                ...
                'renewal_date' => \Carbon\Carbon::parse($this->renewal_date)->toDateString(),
    ...
    {
        return view('livewire.modals.case-manage.add-child-document-recurring-modal');
    }
}
