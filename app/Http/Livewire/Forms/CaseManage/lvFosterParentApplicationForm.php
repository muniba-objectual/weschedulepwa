...
class lvFosterParentApplicationForm extends Component
{
  use WithMedia;
    use WithFileUploads;
...
//       $this->dispatchBrowserEvent('family_composition_change');
        ...
        return view('livewire.forms.case-manage.foster-parent-application-form', compact('FPAFormID', 'userID', 'FPAForm'));
