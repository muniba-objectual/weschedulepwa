...
class Medication extends Component
{
    ...
    */
    ...
    public function deleteRecord() {
        ...
        $this->dispatchBrowserEvent('ReloadWindow');
    ...
    public function render()
    {
        ...
        $LW_medication_entries = Medication_Entry::where('fk_ChildID','=',$this->child->id)->orderBy('updated_at', 'DESC')->paginate(9999,['*'],'Meds');

        return view('livewire.medication', compact('LW_medication_entries'));
    }
