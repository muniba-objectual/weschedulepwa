                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="/img/ws_icon.jpg" alt="User profile picture">
                        </div>
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            @if ($myshift->status == "Pending" && $myshift->actual_start_time)  {{--//start time exists, so the user is signed in--}}
                            <li class="list-group-item">
                                <b>Time Elapsed</b> <a class="float-right">{{$myshift->calculateActiveShiftHours()}}</a>
                            </li>
                            @else
                            <li class="list-group-item">
                                <b>Time Worked</b> <a class="float-right">{{$myshift->calculateActualShiftHours()}}</a>
                            </li>
                        ...
                        <a href="#" class="btn btn-primary btn-block" onclick=startShift("{{$myshift->id}}")><b>Start Shift</b></a>

                        @endif

                        @if ($myshift->status == "Started" && $myshift->actual_shift_start)  {{--//start time exists, so the user is signed in--}}
                        <a href="#" class="btn btn-primary btn-block" onclick=stopShift("{{$myshift->id}}")><b>End Shift</b></a>
                        @endif
                ...
                <div class="card">
                    <div class="card-header p-2">
                        ...
                        <ul class="nav nav-pills" id="myTab">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#shiftform" onclick="//getShiftForm({{$myshift->id}})" data-toggle="tab">Shift Form</a></li>
                            <li class="nav-item"><a class="nav-link" href="#medication" data-toggle="tab">Medication</a></li>
                            <li class="nav-item"><a class="nav-link" href="#incidents" data-toggle="tab">Incidents</a></li>
                            ...
                            <div class="tab-pane active" id="activity">
                                ...
                                <form id="ActivityAddMessageORImage" class="form-horizontal" method="post">
                                    ...
                                    <div class="input-group input-group-sm mb-0">
                                        <input style="margin-bottom: 5px;" class="form-control form-control-sm" id="inputAddMessage" placeholder="Add New Message"><br />

                                        <div class="input-group" >
                                            <label for="button" class="custom-send" onclick="addActivityMessage('{{$myshift->get_child->id}}')">Post Message</label>
                                            <button hidden type="button" class="btn btn-danger" onclick="addActivityMessage('{{$myshift->get_child->id}}')">Send</button>
                                            &nbsp;&nbsp; <label for="fileupload" class="custom-file-upload">
                                                Add Photos
                                            </label>

                                            <input type="file" name="photos[]" id="fileupload" data-url="{{ route('myshifts.edit') }}" multiple="" class="form-control" >
                                ...
                                <div class="post">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm" src="/img/ws_icon.jpg" alt="user image">
                                        <span class="username">
                                                                            <a href="#">{{$activity->get_user->name}}</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                                        <span class="description">Posted {{$activity->getPostTimeRelative()}}</span>
                                    </div>
                                    <!-- /.user-block -->
                                    <p>

                                        @if (str_starts_with($activity->message,"[!photo!]:",))
                                    <div class="col-md-8"><a href="/storage/activities_photos/{{substr($activity->message,35)}}"><img width="50%" src="/storage/activities_photos/{{substr($activity->message,35)}}"  /></a></div>
                                    @else
                                    {{$activity->message}}
                                    @endif
                                    </p>
                          ...
                          01 Dec. 2021
                                    ...
                                    <div>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <h3 class="timeline-header"><a href="#">We-Schedule.ca Management</a> generated a new shift for {{$myshift->get_user->name}}</h3>
                          ...
                          14 Dec. 2021
                                    ...
                                    <div>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <h3 class="timeline-header border-0"><a href="#">{{$myshift->get_user->name}}</a> started their shift.
                                            </h3>
                                        </div>
                                    </div>
                                    <!-- END timeline item -->
                                    ...
                                    <div>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <h3 class="timeline-header"><a href="#">{{$myshift->get_user->name}}</a> posted a comment.</h3>
                                    ...
                                    <div>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <h3 class="timeline-header"><a href="#">{{$myshift->get_user->name}}</a> uploaded new attachments</h3>
                                ...
                                <section class="content">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card card-primary">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="inputDateTime" class="form-control " value="{{ old('datetime') ?? $myshift->get_shiftform->datetime ?? date("Y-m-d H:i:s")  }}">
                                                    ...
                                                    <div class="card card-primary collapsed-card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group" id="medication_form_entry" name="medication_form_entry" style="">
                                                                <style>
                                                                    input[type="file"] {
                                                                        display: none;
                                                                    }
                                                                ...
                                                                <form id="ActivityAddMessageORImage" class="form-horizontal" method="post">
                                                                    ...
                                                                    <div class="input-group input-group-sm mb-0">
                                                                        ...
                                                                        <div class="input-group" >
                                                                            <button hidden type="button" class="btn btn-danger" onclick="addActivityMessage('{{$myshift->get_child->id}}')">Send</button>
                                                                            &nbsp;&nbsp; <label for="fileupload_shiftform" class="custom-file-upload">
                                                                                Add Photos
                                                                            </label>

                                                                            <input type="file" name="photos[]" id="fileupload_shiftform" data-url="#" multiple="" class="form-control" >
                                            ...
                                            <center>Last Updated: {{$myshift->get_shiftform->updated_at}}</center>
                                            @else
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="button" value="Save Changes" class="btn btn-success float-right" onclick="updateShiftForm('{{$myshift->id}}')">
                                        </div>
                                    </div>
                                </section>
                            </div>
                                            ...
                                            <div class="card card-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-bordered dt-responsive nowrap" id="tbl_medicationentries" name="tbl_medicationentries" style="width:100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="table-text">
                                                                    <div>{{$entry->time_to_be_administered}}</div>
                                                                </td>
                                                                <td class="table-text">
                                                                    <div>{{$entry->time_administered}}</div>
                                                                </td>
                                                                <td>
                                                                    <button onclick="delMedicationEntry('{{$entry->id}}',{{$loop->index}})">Delete</button> <!-- TODO: Delete Button -->
                                                                </td>
                                                            </tr>
                                                    ...
                                                    @else
                                                    No medication entries found.<br /><hr>
                                                    @endif
                                                    <!-- Add Task Button
                                                    <div class="form-group">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group" id="medication_form_entry" name="medication_form_entry" style="">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="inputMedication" class="form-control" value="Tylenol - Child" step="1">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="inputDosage">Dosage</label>
                                                                    <input type="text" id="inputDosage" class="form-control" value="10ml" step="1">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="inputTimetobeAdministered">Time to be Administered</label>
                                                                    <input type="text" id="inputTimeToBeAdministered" class="form-control timepicker" />

                                                                    <label for="inputTimeAdministered">Time Administered</label>
                                                                    <input type="text" id="inputTimeAdministered" class="form-control timepicker">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="button" id="inputSubmitEntry" class="form-control" value="Add This Entry"  onclick="addMedicationEntry('{{$myshift->id}}')">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- /.card-body -->
                                            ...
                                            <div class="card card-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="table table-striped table-bordered dt-responsive nowrap" id="tbl_incidententries" name="tbl_incidententries" style="width:100%">
                                                            ...
                                                            <tr>
                                                                <!-- Task Name -->
                                                                <td class="table-text">
                                                                    <div><a href="viewIncident('{{$entry->id}}')">{{$entry->incident_type}}</a></div>
                                                                </td>
                                                                <td class="table-text">
                                                    ...
                                                    @else
                                                    No incident entries found.<br /><hr>
                                                    @endif
                                                    <!-- Add Task Button
                                               <div class="form-group">
                                                   <div class="col-sm-offset-3 col-sm-6">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group" id="medication_form_entry" name="medication_form_entry" style="">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="inputNameOfChild" class="form-control" id="inputNameOfChild" readonly value="{{$myshift->get_child->initials}}" >
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputDOB">Date of Birth</label>
                                                                    <input type="inputDOB" class="form-control" id="inputDOB" readonly value="{{$myshift->get_child->DOB}}" >
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputDateofPlacement">Date of Placement</label>
                                                                    <input type="inputDateofPlacement" class="form-control" id="inputDateofPlacement" readonly value="{{Str::before($myshift->start,' ')}}" >
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputFosterHome">Foster Home</label>
                                                                    <input type="inputFosterHome" class="form-control" id="inputFosterHome" >
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputPlacingAgency">Placing Agency</label>
                                                                    <input type="inputPlacingAgency" class="form-control" id="inputPlacingAgency" >
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputLegalGuardian">Legal Guardian's Name</label>
                                                                    <input type="inputLegalGuardian" class="form-control" id="inputLegalGuardian" >
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <br /><b>*Carpe Diem must submit Serious Occurrence Reports to Ministry within 24 hours</b>

                                                                    <label for="inputIncidentType">Incident</label>
                                                                    <select id="inputIncidentType" class="form-control">
                                                                        <option value="Serious Occurence">-Serious Occurence-</option>
                                                                        <option value="Level 1 Serious Occurence">-Level 1 Serious Occurence-</option>
                                                                        <option selected value="Injury">Injury</option>
                                                                        <option value="Property Damage / Destruction">Property Damage / Destruction</option>
                                                                        <option value="Disclosure">Disclosure</option>
                                                                        <option value="Alcohol / Drug Use">Alcohol / Drug Use</option>
                                                                        <option value="Sexualized Behaviour">Sexualized Behaviour</option>
                                                                        <option value="Lying">Lying</option>
                                                                        <option value="School Issues (Concern, Suspension)">School Issues (Concern, Suspension)</option>
                                                                        <option value="Food Issues (hoarding)">Food Issues (hoarding)</option>
                                                                        <option value="Aggression / Defiance / Tantrums">Aggression / Definance / Tantrums</option>
                                                                        <option value="Medication Error">Medication Error</option>
                                                                        <option value="Stealing">Stealing</option>
                                                                        <option value="Fire Setting">Fire Setting</option>
                                                                        <option value="Issues Relating to Visits or Family Contact">Issues Relating to Visits or Family Contact</option>
                                                                        <option value="Suicidal Thoughts or Attempts / Self-Harm">Suicidal Thoughts or Attempts / Self-Harm</option>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="inputSeriousOccurence">Serious Occurence</label>
                                                                    <select id="inputSeriousOccurence" class="form-control">
                                                                        <option value="Death">Death</option>
                                                                        <option value="Serious Injury">Serious Injury</option>
                                                                        <option selected value="Serious Illness">Serious Illness</option>
                                                                        <option value="Serious Individual Action">Serious Individual Action</option>
                                                                        <option value="Restrictive Intervention">Restriction Intervention</option>
                                                                        <option value="Abuse or Mistreatment">Abuse or Mistreatment</option>
                                                                        <option value="Error or Omission">Error or Omission</option>
                                                                        <option value="Serious Complaint">Serious Complaint</option>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="inputLevel1SeriousOccurence">Level 1 - Serious Occurence</label>
                                                                    <select id="inputLevel1SeriousOccurence" class="form-control">
                                                                        <option value="Media Coverage">Media Coverage</option>
                                                                        <option value="Emeregency Services">Emergency Services used in response to a significant incident involving a client</option>

                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="inputDateofIncident">Date of Incident</label>
                                                                    <input type="inputDateofIncident" class="form-control" id="inputDateofIncident" value="{{Str::before($myshift->start,' ')}}" >
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputTimeDuration">Time/Duration</label>
                                                                    <input type="inputTimeDuration" class="form-control" id="inputTimeDuration" >
                                                                </div>

                                                                <div class="form-group">

                                                                    <label for="inputDateTimeReportReceived">Date/Time Report Received</label>
                                                                    <input type="inputDateTimeReportReceived" class="form-control" id="inputDateTimeReportReceived" value="{{Str::before($myshift->start,' ')}}">
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputLocationofIncident">Location of Incident</label>
                                                                    <textarea id="inputLocationofIncident" class="form-control" rows="4"></textarea>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputAntecedent">Antecedent leading to the Incident</label>
                                                                    <textarea id="inputAntecedent" class="form-control" rows="4"></textarea>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputDescription">Description of Incident (What, When, Where and How)</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="inputWhoWasNotified">Who Was Notified</label><br />
                                                                    <input type="checkbox" checked name="inputWhoWasNotified[]" value="Carpe Diem Case Manager / Supervisor"> Carpe Diem Case Manager / Supervisor<br>
                                                                    <input type="checkbox" name="inputWhoWasNotified[]" value="Carpe Diem On Call Worker"> Carpe Diem On Call Worker - (FOSTER PARENT – Call After Hours 905-799-2947x8)<br>
                                                                    <input type="checkbox" name="inputWhoWasNotified[]" value="CAS Worker /After Hours Worker"> CAS Worker /After Hours Worker - (TO BE DONE BY CARPE DIEM ON CALL WORKER)<br>
                                                                    <input type="checkbox" name="inputWhoWasNotified[]" value=Other"> Other<br>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputPhysicalInjuries">Physical Injuries (Include specific details of injury and medical intervention)</label>
                                                                    <textarea id="inputPhysicalInjuries" class="form-control" rows="4"></textarea>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputPropertyDamage">Property Damage (Attach Damage Form)</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="button" id="inputSubmitEntry" class="form-control" value="Add This Entry"  onclick="AddIncidentEntry('{{$myshift->id}}')">
                                                                </div>
