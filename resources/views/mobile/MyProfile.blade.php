  ...
  <style>
    ...
    <div id="appCapsule" class="full-height">
        ...
        <div class="section mt-2">
            <div class="profile-head glass p-3">
                <div class="avatar m-0">
                    @if (!$user->profile_pic)
                    <img src="/mobilekit/assets/img/sample/avatar/avatar1.jpg" alt="avatar" class="imaged w64 ">
                    @else                        <img src="/storage/profile_pic/{{substr($user->profile_pic,20)}}" alt="avatar" class="imaged w64 ">
                    @endif
                </div>
                <div class="in">
                    <h3 class="name mt-2">{{$user->name}} </h3>
                    <h3 class="name font-light">{{$user->get_user_type->name}}</h3>
                    <!-- <h3 class="subtext">
                    </h3> -->
                </div>
            </div>
        ...
        <div class="section full mt-2 ">
            ...
            <!-- <ul class="nav nav-tabs capsuled" role="tablist">
                ...
                @if ($user->user_type == 1)
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#CYSW_Profile" role="tab">
                        <ion-icon name="person-outline"></ion-icon> MY CYSW PROFILE
        ...
        <div class="section full mx-3 mt-2 mb-0">
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="profile" role="tabpanel">
                    ...
                    <h3 class="today-shift">My Profile</h3>
                        <div class="pb-4">
                            <form action="{{route('mobile_myprofile.edit')}}" method="post">
                                {{ csrf_field() }}
                        ...
                        <form id="frm_myprofile" action="{{route('mobile_myprofile.edit')}}" method="post">
                            {{ csrf_field() }}
                                ...
                                @if ($user->drivers_license)
                                    ...
                                    <div>
                                        <input type="file" name="drivers_license" id="drivers_license"
                                               data-url="{{ route('mobile_myprofile.edit') }}"
                            ...
                            <button type="button" onclick="submit_form();"
                                    class="prof btn btn-block {{ config('adminlte.classes_auth_btn', 'btn-flat btn-primary') }}">
                ...
                <!-- CYSW_Profile -->
                <div class="tab-pane fade" id="CYSW_Profile" role="tabpanel">

                     @if ($user->user_type == 1)
                        @livewire('mobile.c-y-s-w-profile',['user' => $user])
                    @endif
                </div>
