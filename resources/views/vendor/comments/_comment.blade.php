...
<div id="comment-{{ $comment->getKey() }}" class="post">
    <!--
    ...
    -->
        <!--
        <img class="mr-3" src="http://localhost:8000/img/ws_icon.jpg" width="10%" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar">
    <div class="media-body container-fluid">
        ...
        <div class="card col-md-6 formatMe" >{!! $markdown->line($comment->comment) !!}</div>

        <div>
            -->
            <div class="user-block">
                <img class="img-circle img-bordered-sm" src="/img/ws_icon.jpg2" alt="user image">
                <span class="username">
                                                                            <a href="#"> {{$comment->commenter->name ?? $comment->guest_name}}</a>

                        </span>
                <span class="description">{{ $comment->created_at->diffForHumans() }}</span>
            </div><!-- /.user-block -->
        <div class="formatMe" >{!! $markdown->line($comment->comment) !!}</div>
