...
>
    <div class="comments-comment">
        ...
        @if ($comment->commentator->profile_pic)

            <img class="comments-avatar" style="padding-left:5px" src="/storage/{{substr($comment->commentator->profile_pic, 7)}}" />
            @else
                <img class="comments-avatar" style="padding-left:5px" src='/img/default-avatar.png' />
...
{{--                            </li>--}}
            ...
            @if($comment->isPending())
                <div class="comments-approval">
                    <span>
                        {{__('comments::comments.awaits_aproval')}}
                    </span>
