                        ...
                        <div class="row">
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-yellow">
                                    ...
                                    <a href="{{route('casemanage_showFosterParentDashboard_2_0')}}" class="small-box-footer"><i
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="small-box bg-cyan">
                                    ...
                                    <a href="{{route('casemanage_showFosterParentDashboard_2_1')}}" class="small-box-footer"><i
                                            class="fas fa-arrow-circle-right"></i></a>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="small-box bg-green">
                                    ...
                                    <a href="{{route('casemanage_showFosterParentDashboard_2_2')}}" class="small-box-footer"><i
                                            class="fas fa-arrow-circle-right"></i></a>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="small-box bg-red">
                                    ...
                                    <a href="{{route('casemanage_showFosterParentDashboard_2_3')}}" class="small-box-footer"><i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
        ...
        <div class="container-fluid mt-3 mb-3">
            ...
            <div class="container-fluid">
                <div class="row justify-content-md">
                    <div class="container-fluid mt-3 mb-3">
                        @livewire('dashboard-elements.lists.case-manage.all-foster-parents-list',['search' => $search])
                    </div>
                </div>
