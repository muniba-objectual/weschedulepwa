                        ...
                        <div class="row">
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-info">
                                    <div class="inner">
                                        <h5>3.0 - Carpe Diem Staff</h5>

                                    </div>
                                    <div class="icon">
                                        <i class="fas fa-users"></i>
                                    </div><br />
                                    <a href="javascript:window.livewire.emit('modal.open', 'modals.case-manage.create-staff-modal', {'zzz':0}, {'size':'xl'})" class="small-box-footer"><i
                                            class="fas fa-plus-circle"></i> Add New Staff</a>
                                </div>
        ...
        <div class="container-fluid mt-3 mb-3">
            ...
            <div class="container-fluid">
                <div class="row justify-content-md">
                    <div class="container-fluid mt-3 mb-3">
                        @livewire('dashboard-elements.lists.case-manage.staff.all-staff-list',['search' => $search])
                    </div>
                </div>
