...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div id="banner" style="background-color:red; color:white; margin:10% padding:15%;" class="text-center">
                @if ($myshift->status == 'Ended - Incomplete' && !$myshift->get_shiftform)
                    <p>REMINDER -- Your shift has ended and you <b>HAVE NOT</b> completed the compulsary Shift Form.
                    </p>
                @endif
            </div>
            <div class="row">
                <!-- Shift Card Details -->
                @include ('myshifts.components.shift_card_details')

                <!-- End of Shift Card Details -->
                        ...
                        <div class="card-header p-2">
                            ...
                            <ul class="nav nav-pills" id="myTab">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#shiftform"
                                        onclick="//getShiftForm({{ $myshift->id }})" data-toggle="tab">Shift
                                        Form</a></li>
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="input-group input-group-sm mb-0">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <button hidden type="button" class="btn btn-danger"
                                                    onclick="addActivityMessage('{{ $myshift->get_child->id }}')">Send
                                                </button>
                                            ...
                                            <div class="post">
                                                <div class="user-block">
                                                    ...
                                                    <span class="description">Posted
                                                        {{ $diff = Carbon\Carbon::parse($activity->updated_at)->diffForHumans(Carbon\Carbon::now()) }}</span>
                                                </div>
                                                <!-- /.user-block -->
                                                <p>
                                                    ...
                                                    @if ($activity->event == 'Photo')
                                                        <div class="col-md-8"><a
                                                                href="/storage/activities_photos/{{ substr($activity->description, 25) }}"><img
                                                                    width="50%"
                                ...
                                <div class="tab-pane" id="timeline">
                                    ...
                                    <div class="timeline timeline-inverse">
                                        ...
                                        @if ($myshift_timeline->count() >= 0)

                                            {{-- $myshift_timeline --}}
                                            @foreach ($myshift_timeline as $key => $timeline)
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="timeline-item">
                                                            <span class="time"><i class="far fa-clock"></i>
                                                                {{ $diff = Carbon\Carbon::parse($details->updated_at)->diffForHumans(Carbon\Carbon::now()) }}</span>

                                                            @if ($details->event == 'Message')
                                                                <h3 class="timeline-header"><a
                                                                        href="#">{{ $myshift->get_user->name }}</a>
                                                                    posted a new message to <a
                                                                        href="#">{{ $myshift->get_child->initials }}'s</a>
                                                                    Activity Wall </h3>
                                                            @endif
                                        ...
                                        <div>
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <h3 class="timeline-header"><a href="#">We-Schedule.ca
                                                        Management</a>
                                                    generated a new shift for {{ $myshift->get_user->name }}</h3>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                                        ...
                                                                        <div class="input-group input-group-sm mb-0">
                                                                            ...
                                                                            <div class="input-group">
                                                                                <button hidden type="button"
                                                                                    ...
                                                                                    onclick="addActivityMessage('{{ $myshift->get_child->id }}')">
                                                                                    Send
                                                                                </button>
                                                                                &nbsp;&nbsp; <label
                                                ...
                                                @if ($myshift->get_shiftform)
                                                    <center>Last
                                                        Updated: {{ $myshift->get_shiftform->updated_at }}</center>
                                                @else
                                            ...
                                            <div class="col-md-12">
                                                <div class="card card-primary">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @livewire('medication', ['myshift' => $myshift])
                                                                ...
                                                                <div class="form-group" id="medication_form_entry"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select id="inputIncidentType"
                                                                            ...
                                                                            <option selected value="Injury">Injury
                                                                            </option>
    ...
    <script type="text/javascript">
        ...
        */
        ...
        function refreshTable() {
            $('#ShiftCardDetails').fadeOut();
            $('#ShiftCardDetails').innerHTML = "";
            $('#ShiftCardDetails').load("{{ route('myshifts.getShiftCardDetails', 'ShiftID=' . $myshift->id) }}",
            function() {
                $('#ShiftCardDetails').fadeIn();
            });
        }
    </script>
