  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    @livewire("case-manage.layout.navbar-white")
            ...
            <div class="card-header pb-0 p-3 pt-0">
              <div class="row">
                ...
                <div class="col-md-4 text-end">
                  <a href="javascript:window.livewire.emit('modal.open', 'case-manage.modals.activity-modal', {'zzz':0}, {'size':'3xl'})">
          ...
          <div class="card h-100">
            <div class="card-header pb-0 pt-0">
              <div class="row">
                ...
                <div class="col-md-4 text-end">
                  <a href="javascript:window.livewire.emit('modal.open', 'case-manage.modals.timeline-modal', {'zzz':0}, {'size':'xl'})">
          ...
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              <div class="d-flex justify-content-between align-items-center safety-btn px-2 py-2 icon-move-right" 
                wire:click="$emit('modal.open', 'case-manage.modals.emergency-contacts-modal', {'zzz':0}, {'size':'xl'})">
                <div class="d-flex align-items-center">
              ...
              <div class="d-flex justify-content-between align-items-center safety-btn px-2 py-2 icon-move-right mt-2"
                wire:click="$emit('modal.open', 'case-manage.modals.identifying-information-modal', {'zzz':0}, {'size':'xl'})">
                <div class="d-flex align-items-center">
                  <img src="{{ asset('img/form.svg') }}" class="avatar avatar-sm me-2">
              ...
              <div class="d-flex justify-content-between align-items-center safety-btn px-2 py-2 icon-move-right mt-2"
                wire:click="$emit('modal.open', 'case-manage.modals.medical-information-modal', {'zzz':0}, {'size':'xl'})">
                <div class="d-flex align-items-center">
                  <img src="{{ asset('img/form.svg') }}" class="avatar avatar-sm me-2">
              ...
              <div class="d-flex justify-content-between align-items-center safety-btn px-2 py-2 icon-move-right mt-2"
                wire:click="$emit('modal.open', 'case-manage.modals.other-information-modal', {'zzz':0}, {'size':'xl'})">
                <div class="d-flex align-items-center">
                  <img src="{{ asset('img/form.svg') }}" class="avatar avatar-sm me-2">
              ...
              <div class="col-12 col-xl-6 mt-2 mt-md-0 mt-lg-0">
                <div class="card-entries p-3">
                  ...
                  <button type="button" class="btn bg-gradient-dark w-100 mt-4 mb-0 text-capitalize"
                    wire:click="$emit('modal.open', 'case-manage.modals.s-r-a-report-modal', {'zzz':0}, {'size':'3xl'})">Generate SRA Report
                  </button>
                </div>
              </div>
              <div class="col-12 col-xl-6 mt-2 mt-md-0 mt-lg-0">
