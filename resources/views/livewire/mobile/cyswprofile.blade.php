<div>
    ...
    <form action="{{route('mobile_cysw_profile.edit')}}" method="post" wire:submit.prevent="save">
        {{ csrf_field() }}
        ...
        <div class="card card-primary">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    {{-- Reference 1 field --}}
                    <div class="accordion" wire:ignore id="ref1">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <h5>Diploma/Certificate #1</h5>
                                </button>
                            </h2>
                            <div id="accord_dipcert1" class="accordion-collapse collapse" >
                                <div class="accordion-body">
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            <label for="resume">Attachment</label>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <h5>Diploma/Certificate #2</h5>
                                </button>
                            </h2>
                            <div id="accord_dipcert_2" class="accordion-collapse collapse" >
                                <div class="accordion-body">
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            <label for="resume">Attachment</label>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <h5>Diploma/Certificate #3</h5>
                                </button>
                            </h2>
                            <div id="accord_dipcert_3" class="accordion-collapse collapse" >
                                <div class="accordion-body">
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            <label for="resume">Attachment</label>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <h5>Diploma/Certificate #4</h5>
                                </button>
                            </h2>
                            <div id="accord_dipcert_4" class="accordion-collapse collapse" >
                                <div class="accordion-body">
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            <label for="resume">Attachment</label>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <h5>Diploma/Certificate #5</h5>
                                </button>
                            </h2>
                            <div id="accord_dipcert_5" class="accordion-collapse collapse" >
                                <div class="accordion-body">
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            <label for="resume">Attachment</label>
            ...
            <div class="card card-primary">
                <div class="card-header pb-0 mb-0 ">
                    <h5 >Criminal Reference Checks</h5>
                </div>
                <div class="card-body">
                   <!-- CrimRef_1 -->
                    <div class="accordion" wire:ignore>
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <h5>Criminal Reference Check #1</h5>

                                </button>
                            </h2>
                            <div id="crim_1" class="accordion-collapse collapse" >
                                <div class="accordion-body">
                                    <div class="card-body">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <h5>Criminal Reference Check #2</h5>

                                </button>
                            </h2>
                            <div id="crim_2" class="accordion-collapse collapse" >
                                <div class="accordion-body">
                                    <div class="card-body">
            ...
            <div class="card-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                <h5>Proof of COVID-19 Vaccination</h5>

                            </button>
                        </h2>
                        <div id="covid19" class="accordion-collapse collapse" >
                            <div class="accordion-body">
                                <div class="card-body">
                ...
                <div class="accordion" wire:ignore>
                    <div class="accordion-item">
                        ...
                        <div id="bank" class="accordion-collapse collapse" >
                            <div class="accordion-body">
                                <div class="input-group mb-3">
                ...
                {{-- Carpe Diem Confidentiality Agreement field --}}
                    <div class="accordion" wire:ignore>
                        <div class="accordion-item">
                            ...
                            <div id="confidentiality" class="accordion-collapse collapse" >
                                <div class="accordion-body">
                                    <div class="card-body">
                ...
                <div class="accordion" wire:ignore>
                    <div class="accordion-item">
                        ...
                        <div id="release" class="accordion-collapse collapse" >
                            <div class="accordion-body">
                                <div class="card-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                <h5>Child Welfare Check</h5>

                            </button>
                        </h2>
                        <div id="childwelfare" class="accordion-collapse collapse" >
                            <div class="accordion-body">
                                <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div class="accordion" wire:ignore>
                    <div class="accordion-item">
                        ...
                        <div id="drivers" class="accordion-collapse collapse" >
                            <div class="accordion-body">
                                <div class="card-body">
                ...
                <div class="accordion" wire:ignore>
                    <div class="accordion-item">
                        ...
                        <div id="second_photo_id" class="accordion-collapse collapse" >
                            <div class="accordion-body">
                                <div class="card-body">
                ...
                <div class="accordion" wire:ignore>
                    <div class="accordion-item">
                        ...
                        <div id="insurance" class="accordion-collapse collapse" >
                            <div class="accordion-body">
                                <div class="card-body">
                ...
                <div class="accordion" wire:ignore>
                    <div class="accordion-item">
                        ...
                        <div id="vehicle" class="accordion-collapse collapse" >
                            <div class="accordion-body">
