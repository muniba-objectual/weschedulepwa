<div wire:ingore>
    ...
    <x-wire-elements-pro::bootstrap.modal on-submit="save" :content-padding="true">
        <x-slot name="title">Log In-Person Meeting</x-slot>
       ...
       {{-- DOB field --}}
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input wire:ignore wire:model="callDateTime" type="text" id="callDateTime" name="callDateTime" class="form-control @error('callDateTime') is-invalid @enderror"
                           value="{{ old('callDateTime') }}" placeholder="Enter Meeting Date/Time" autofocus>
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <textarea rows="5" wire:ignore wire:model="notes" class="form-control @error('notes') is-invalid @enderror" placeholder="Enter Meeting Notes"></textarea>
