<main class="main-content  mt-0">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <img src="{{ asset('img/ws.png') }}" class="navbar-brand-img w-40 m-auto" alt="main_logo">
          ...
          <div class="card z-index-0">
            ...
            <div class="row px-xl-5 px-sm-4 px-3">
              <div class="col-3 ms-auto px-1">
                <a class="btn btn-outline-light w-100 padd-social" href="javascript:;">
            ...
            <div class="card-body">
              <form role="form text-left">
                ...
                <p class="text-sm mt-3 mb-0">Already have an account? 
                    <a href="{{ route('we-schedule.signin') }}" class="text-dark font-weight-bolder">Sign in</a>
                </p>
              </form>
            </div>
          </div>
  ...
  @livewire("we-schedule.layout.footer")
</main>