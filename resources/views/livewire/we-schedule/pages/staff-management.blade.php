    ...
    <div class="container-fluid py-4">
      <div class="d-flex justify-content-end">
        <button type="button" class="btn bg-gradient-dark w-60 w-md-20 w-lg-15 mb-2" 
                wire:click="$emit('modal.open', 'we-schedule.modals.add-update-staff-modal', {'methed': 'add'}, {'size':'md'})">Add New
        </button>
      </div>
      <div class="row">
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2"> Assigned
                      Children</th>
                ...
                <tbody>
                  <tr>
                    <td colspan="5">
                      <p class="text-sm font-weight-bold mb-0">Super Administrator</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p class="text-xs font-weight-bold mb-0">test@test.com</p>
                    </td>
                    <td>
                      <p class="text-xs font-weight-bold mb-0">Super Administrator</p>
                    </td>
                    <td>
                      <p class="text-xs font-weight-bold mb-0">Adam Smith</p>
                    </td>
                      ...
                      <ul class="dropdown-menu shadow  dropdown-menu-end px-2 me-sm-n4"
                        ...
                        <li class="mb-2">
                          <a class="dropdown-item border-radius-md" 
                             href="javascript:window.livewire.emit('modal.open', 'we-schedule.modals.add-update-staff-modal', {'methed': 'update'}, {'size':'md'})" >
                  ...
                  <tr>
                    <td colspan="5">
                      <p class="text-sm font-weight-bold mb-0">CYSW</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <tr>
                    <td colspan="5">
                      <p class="text-sm font-weight-bold mb-0"> Foster Parents
                      </p>
                    </td>
                  </tr>
                  <tr>
