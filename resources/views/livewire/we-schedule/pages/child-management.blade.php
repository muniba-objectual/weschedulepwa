    ...
    <div class="container-fluid py-4">
      <div class="d-flex justify-content-end">
        <button type="button" class="btn bg-gradient-dark w-60 w-md-20 w-lg-15 mb-2" 
                wire:click="$emit('modal.open', 'we-schedule.modals.add-update-child-modal', {'methed': 'add'}, {'size':'md'})">Add New
        </button>
      </div>
      <div class="row">
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2"> SRA</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2"> Assigned Home
                    </th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <p class="text-xs font-weight-bold mb-0">2010-01-01</p>
                    </td>
                    <td>
                      <p class="text-xs font-weight-bold mb-0">Testing</p>
                    </td>
                    <td>
                      <p class="text-xs font-weight-bold mb-0">NO </p>
                    </td>
                    <td>
                      <p class="text-xs font-weight-bold mb-0">Test Home </p>
                    </td>
                    <td class="align-middle text-center">
                      ...
                      <li class="mb-2">
                        <a class="dropdown-item border-radius-md" 
                           href="javascript:window.livewire.emit('modal.open', 'we-schedule.modals.add-update-child-modal', {'methed': 'update'}, {'size':'md'})" >
